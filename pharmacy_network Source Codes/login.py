...
def login_tab(tab,sign,home,notebook,path,admin_pannel):
        ...
        state = ctk.StringVar(value="loged_out")
        
        ctk.CTkButton(nav,text="",width = 50,fg_color="white",hover_color="white",
                   command=lambda: notebook.select(home),
                   image=tab.back).grid(row=0,column=0,padx=5,pady=5,sticky="w")
        ...
        entry_frame1.grid(row=1,column=0,columnspan=3,pady=80)
        ...
        roles=["USER","PARMECIENT","DOCTOR","ADMIN"]
        ...
        username=ctk.CTkEntry(alig_frame2,corner_radius=50,text_color="black",width=270,height=35,fg_color="white",border_color="#DB0A41")
        ...
        password=ctk.CTkEntry(alig_frame3,text_color="black",corner_radius=50,width=270,height=35,fg_color="white",border_color="#DB0A41")
        ...
        join_now=ctk.CTkButton(signin_box,text="Join Now",corner_radius=50,font=("calibri",15,"bold"),hover_color = "aqua",
